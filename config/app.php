...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        SRP\Providers\AppServiceProvider::class,
        SRP\Providers\AuthServiceProvider::class,
        SRP\Providers\BroadcastServiceProvider::class,
        SRP\Providers\EventServiceProvider::class,
        SRP\Providers\RouteServiceProvider::class,
        //SRP\Providers\RepositoryServiceProvider::class,
