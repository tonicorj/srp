...
@section('content')
    <div class="content-header">
        <h1>{!! trans('messages.t_tipoacao') !!}</h1>
    </div>
    <div class="content">
        <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            oTable = $('#table2').DataTable({
                ...
                "ordering": false,
                "paging": true,
                "ajax": "{{ asset( 'tipoacao/_json' ) }}",
                bAutoWidth:true,
                columns: [
                    {"data": "TIPO_ACAO_MARKETING_DESCRICAO"},
                    {"data": "ID_TIPO_ACAO_MARKETING"}
                ],
                dom: 'Bfrtip',
                buttons: [
            ...
            $('#inc').on('click', function () {
                location.href="{!! asset('tipoacao/create') !!}";
            });
            ...
            $('#alt').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    $_id = $_data['ID_TIPO_ACAO_MARKETING'];
                    url = '{{ asset('tipoacao/edit')  }}/' + $_id;
                    location.href=url;
                }
            });
            ...
            $('#exc').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    var _descr = $_data['TIPO_ACAO_MARKETING_DESCRICAO'];
                    bootbox.dialog({
                        ...
                        buttons:{
                            yes: {
                                ...
                                callback: function() {
                                    // pega o código da cidade
                                    var $_id = $_data['ID_TIPO_ACAO_MARKETING'];
