    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#inc').on('click', function () {
                location.href="{!! asset('escopos/create') !!}";
            });
            ...
            $('#exc').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    var _descr = $_data['ESCOPO_DESCRICAO'];
                    bootbox.dialog({
                        ...
                        buttons:{
                            yes: {
                                ...
                                callback: function() {
                                    // pega o código da cidade
                                    var $_id = $_data['ID_ESCOPO'];
                                    var url = '{{ asset('escopos/destroy')  }}/' + $_id;
                                    //location.href=url;
                                    //alert(url);
                                    $.ajax({
                                        type: "get",
