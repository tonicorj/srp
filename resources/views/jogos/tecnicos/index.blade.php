            ...
            <div class="panel-body">
                <table class='table table-striped' id="tbl_">
                    ...
                    @foreach ($tecnicos as $reg)
                        <tr>
                            {!! Form::open(['route' => [ 'tecnicos.destroy' ,'id' => $reg->ID_TECNICO]
                            , 'method' =>'DELETE'
                            , 'id' => "delete-form-{$reg->ID_TECNICO}"
                            , 'style' => 'display:none'
                            ]) !!}
                            {!! Form::close() !!}
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            location.href = "{!! asset('jogos/tecnicos/create') !!}";
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                // pega o código
                                id = dados[0];
                                url = '{{ asset('jogos/tecnicos')  }}/' + id + '/edit';
                                location.href = url;
                            }
                        }
                    },
