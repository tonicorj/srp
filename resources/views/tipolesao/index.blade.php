...
@section('content')
    <div class="content-header">
        <h1>{!! trans('messages.t_tipolesao') !!}</h1>
    </div>
    <div class="content">
        <div class="row">
        ...
        <div class="row" >
            <table class="display" id="table2">
                <thead>
                <tr>
                    <th>{!! trans('messages.tit_tipolesao') !!}</th>
                </tr>
                </thead>
            </table>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            oTable = $('#table2').DataTable({
                ...
                "ordering": false,
                "paging": true,
                "ajax": "{{ asset( 'tipolesao/_json' ) }}",
                bAutoWidth:true,
                columns: [
                    {"data": "TIPO_LESAO_DESCRICAO"},
                    {"data": "ID_TIPO_LESAO"}
                ],
                dom: 'Bfrtip',
                buttons: [
            ...
            $('#inc').on('click', function () {
                location.href="{!! asset('tipolesao/create') !!}";
            });
            ...
            $('#alt').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    $_id = $_data['ID_TIPO_LESAO'];
                    url = '{{ asset('tipolesao/edit')  }}/' + $_id;
                    location.href=url;
                }
            });
            ...
            $('#exc').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    var _descr = $_data['TIPO_LESAO_DESCRICAO'];
                    bootbox.dialog({
