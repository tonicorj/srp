            ...
            <div class="panel-body">
                <table class='table table-striped' id="tbl_">
                    ...
                    @foreach ($origens as $reg)
                        <tr>
                            <td>{{$reg->ID_ORIGEM_LESAO}}</td>
                            <td>{{$reg->ORIGEM_LESAO_DESCRICAO}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            location.href = "{!! asset('DM/origem_lesao/create') !!}";
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                // pega o código
                                id = dados[0];
                                url = '{{ asset('DM/origem_lesao')  }}/' + id + '/edit';
                                location.href = url;
                            }
                        }
                    },
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                bootbox.dialog({
                                    ...
                                    message: "{!! trans('messages.exc_origem_lesao') !!}" + _descr + "?",
                                    buttons: {
                                        yes: {
                                            label: "Sim",
                                            ...
                                            callback: function () {
                                                // pega o código
                                                var id = dados[0];
                                                var url = '{{ asset('DM/origem_lesao')  }}/' + $_id + '/destroy';
                                                //location.href=url;
                                                //alert(url);
                                                $.ajax({
                                                    type: "get",
