        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class='table table-striped' id="tbl_">
                    ...
                    <tbody>
                    @foreach ($cuidados as $reg)
                        <tr>
                            {!! Form::open(['route' => [ 'cuidados.destroy' ,'id' => $reg->ID_JOGADOR]
                            , 'method' =>'DELETE'
                            ...
                            <td>{{data_display($reg->DATA_INCLUSAO)}}</td>
                            <td>{{$reg->NOME_MEDICO}}</td>
                            <td>{{$reg->TIPO_SANGUINEO}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            location.href = "{!! asset('dm/cuidados/create') !!}";
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                bootbox.dialog({
                                    ...
                                    message: "{!! trans('messages.exc_cuidados') !!}" + _descr + "?",
                                    buttons: {
                                        yes: {
                                            label: "Sim",
