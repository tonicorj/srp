        ...
        <div class="panel-body">
            <table class='table table-striped' id="tbl_">
                ...
                @foreach ($funcionarios as $reg)
                    <tr>
                        {!! Form::open(['route' => [ 'funcionarios.destroy' ,'id' => $reg->ID_USUARIO]
                        , 'method' =>'DELETE'
                        , 'id' => "delete-form-{$reg->ID_USUARIO}"
                        , 'style' => 'display:none'
                        ]) !!}
                        {!! Form::close() !!}
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            location.href = "{!! asset('adm/funcionarios/create') !!}";
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                // pega o código
                                id = dados[0];
                                url = '{{ asset('adm/funcionarios')  }}/' + id + '/edit';
                                location.href = url;
                            }
                        }
                    },
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                bootbox.dialog({
                                    ...
                                    message: "{!! trans('messages.exc_funcionario') !!}" + _descr + "?",
                                    buttons: {
                                        yes: {
                                            label: "Sim",
