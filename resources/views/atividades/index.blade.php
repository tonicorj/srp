    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#inc').on('click', function () {
                location.href="{!! asset('atividadesped') !!}";
            });
            ...
            $('#alt').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    $_id = $_data['ID_ATIVIDADE'];
                    url = '{{ asset('atividades/edit')  }}/' + $_id;
                    location.href=url;
                }
            });
            ...
            $('#exc').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    var _descr = $_data['ATIVIDADE_DESCRICAO'];
                    bootbox.dialog({
                        ...
                        buttons:{
                            yes: {
                                ...
                                callback: function() {
                                    // pega o código da cidade
                                    var $_id = $_data['ID_ATIVIDADE'];
                                    var url = '{{ asset('atividadesped')  }}/' + $_id;
                                    //location.href=url;
                                    //alert(url);
                                    $.ajax({
                                        type: "get",
