            ...
            <table class='table table-striped' id="tbl_">
                ...
                @foreach ($prontuarios as $p)
                    <tr>
                        ...
                        <td>{{data_display($p->data_prontuario)}}</td>
                        <td>{{$p->medico_nome }}</td>
                    </tr>
                @endforeach
                </tbody>
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            location.href = "{!! asset('DM/prontuario/create') !!}" + "?dm=" + id;
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                // pega o código
                                id = dados[0];
                                url = '{{ asset('DM/prontuario')  }}/' + id + '/edit';
                                location.href = url;
                            }
                        }
                    },
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                bootbox.dialog({
                                    ...
                                    message: "{!! trans('messages.exc_prontuario_dia') !!}" + _descr + "?",
                                    buttons: {
                                        yes: {
                                            label: "Sim",
                                            ...
                                            callback: function () {
                                                ...
                                                var id = dados[0];
                                                var url = '{{ asset('DM/prontuario')  }}/' + $_id + '/destroy';
                                                //location.href=url;
                                                //alert(url);
                                                $.ajax({
                                                    type: "get",
