    ...
    <div class="content">
        ...
        <div class="row" >
            <table class="display" id="table2">
                <thead>
                <tr>
                    <th>{!! trans('messages.tit_contas') !!}</th>
                    <th>{!! trans('messages.tit_contas') !!}</th>
                    <th>{!! trans('messages.tit_contas_num') !!}</th>
                </tr>
                </thead>
            </table>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#inc').on('click', function () {
                location.href="{!! asset('contas/create') !!}";
            });
            ...
            $('#exc').on('click', function() {
                ...
                if ($_data == null) {
                    ...
                    bootbox.dialog({
                        ...
                        message: "{!! trans('messages.exc_contas') !!}" + _descr + "?",
                        buttons:{
                            yes: {
                                label:"Sim",
                                ...
                                callback: function() {
                                    ...
                                    var url = '{{ asset('contas/destroy')  }}/' + $_id;
                                    //location.href=url;
                                    //alert(url);
                                    $.ajax({
                                        type: "get",
