        ...
        <div class="panel-body">
            <table class='table table-striped' id="tbl_">
                ...
                @foreach ($atendimentos as $reg)
                    <tr>
                        {!! Form::open(['route' => [ 'atendimentoSS_grupos.destroy' ,'id' => $reg->ID_ATEND_ASSIST_SOCIAL]
                        , 'method' =>'DELETE'
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            location.href = "{!! asset('SSocial/atendimentoSS_grupos/create') !!}";
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                // pega o código
                                id = dados[0];
                                url = '{{ asset('SSocial/atendimentoSS_grupos')  }}/' + id + '/edit';
                                location.href = url;
                            }
                        }
                    },
