        ...
        <div class="panel-body">
            <table class='table table-striped' id="tbl_">
                ...
                @foreach ($atendimentos as $reg)
                    <tr>
                        {!! Form::open(['route' => [ 'atendimentopsic_func.destroy' ,'id' => $reg->ID_ATENDIMENTO_PSICOLOGIA]
                        , 'method' =>'DELETE'
                ...
                buttons: [
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            location.href = "{!! asset('psicologia/atendimentopsic_func/create') !!}";
                        }
                    },
                    {
                        ...
                        "action": function (e, dt, node, config) {
                            ...
                            if (dados == null) {
                                ...
                                // pega o código
                                id = dados[0];
                                url = '{{ asset('psicologia/atendimentopsic_func')  }}/' + id + '/edit';
                                location.href = url;
                            }
                        }
                    },
