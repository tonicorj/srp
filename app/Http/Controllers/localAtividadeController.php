...
class localAtividadeController extends Controller
{
    ...
    {
        return view('localatividade.index');
    }

    public function _json() {
        $_sql  = "select A.ID_LOCAL_ATIVIDADE, A.LOCAL_ATIVIDADE_DESCRICAO";
        $_sql .= " from LOCAL_ATIVIDADE A ";
        $_sql .= " order by ";
        $_sql .= "  A.LOCAL_ATIVIDADE_DESCRICAO ";
