...
//use SRP\Http\Requests\CondicaoTempoRequest;
use SRP\CondicaoTempo;
use DB;
...
class condicaoTempoController extends Controller
{
    ...
    {
        return view('condicaotempo.index');
    }

    // retorna a consulta no formato json
    public function _json() {
        $_sql  = "select A.ID_CONDICAO_TEMPO, A.CONDICAO_TEMPO ";
        $_sql .= "from CONDICAO_TEMPO A ";
        $_sql .= "order by ";
        $_sql .= "  A.CONDICAO_TEMPO ";
