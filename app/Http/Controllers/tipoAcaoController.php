...
class tipoAcaoController extends Controller
{
    ...
    {
        return view('tipoacao.index');
    }

    // retorna a consulta no formato json
    public function _json() {
        $_sql  = "select A.ID_TIPO_ACAO_MARKETING, A.TIPO_ACAO_MARKETING_DESCRICAO ";
        $_sql .= " from TIPO_ACAO_MARKETING A ";
        $_sql .= " order by ";
        $_sql .= "  A.TIPO_ACAO_MARKETING_DESCRICAO ";
